...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust| GUI  | Alt  | Left |Right |Space | Bksp | Tab  |Enter |  Up  | Down | PGUP |PGDOWN|Raise |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      ADJUST,  KC_LGUI, KC_LALT, KC_LEFT, KC_RGHT, KC_SPC,  KC_BSPC,  KC_TAB,KC_ENT,  KC_UP,    KC_DOWN,KC_PGUP, KC_PGDN,   RAISE \
      ),
  ...
  [_RAISE] = LAYOUT( \
      KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC, \
     _______,_______,_______, JA_LCBR, JA_RCBR, JA_TILD,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_DEL, \
     _______,_______,_______, JA_LPRN, JA_RPRN, JA_ENVL,                     KC_F6,   KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, \
     _______,_______,_______, JA_LBRC, JA_RBRC, _______,  _______, _______, KC_F12,  _______, _______, KC_PGDN, KC_PGUP, _______, \
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY \
      ),
