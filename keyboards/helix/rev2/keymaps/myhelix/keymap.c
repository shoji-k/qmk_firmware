...
//Lower LOWER
  ...
  [_RAISE] = KEYMAP( \
      ...
      _______, _______, _______, JA_LCBR, JA_RCBR,JA_TILD,                    _______, _______, _______, _______, _______, KC_DEL, \
      _______, _______, _______, JA_LPRN, JA_RPRN,JA_ENVL,                    _______, _______, _______, _______, _______, KC_BSLS, \
      _______, _______, _______, JA_LBRC, JA_RBRC, _______, _______, _______, _______, _______, _______, KC_PGDN, KC_PGUP, _______, \
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |      | Vol- | Vol+ |      |      |      |      |      |RGB ON| HUE+ | SAT+ | VAL+ |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |      |BRITE-|BRITE+|      |      |      |      |      | MODE | HUE- | SAT- | VAL- |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_ADJUST] =  KEYMAP( \
      ...
      _______, _______, _______, KC_VOLD, KC_VOLU, _______, _______, _______, _______, _______, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, \
      _______, _______, _______, RGB_VAD, RGB_VAI, _______, _______, _______, _______, _______, RGB_SMOD,RGB_HUD, RGB_SAD, RGB_VAD \
      )
