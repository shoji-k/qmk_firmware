...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust| Alt  | GUI  | Left |Right |Space | Bksp | Tab  |Enter |  Up  | Down | PGUP |PGDOWN|Raise |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      ADJUST,  KC_LALT, KC_LGUI, KC_LEFT, KC_RGHT, KC_SPC,  KC_BSPC,  KC_TAB,KC_ENT,  KC_UP,    KC_DOWN,KC_PGUP, KC_PGDN,   RAISE \
      ),
